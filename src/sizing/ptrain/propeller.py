...
class HoverPropeller(om.ExplicitComponent):
    ...
    def compute_partials(self, inputs, partials):  
        ...
        partials['p_shaft_unit', 'thrust_total'] = np.eye(N) * (0.5984*(thrust_total/n_motors)**(1/2))/(eta_prop*eta_hover*n_motors*(rho*(0.2500*d_blades**2 - 0.2500*d_hub**2))**0.5000)
        ...
        partials['p_shaft_unit', 'rho'] =   np.eye(N) * -(0.1995*(0.2500*d_blades**2 - 0.2500*d_hub**2)*(thrust_total/n_motors)**1.5000)/(eta_prop*eta_hover*(rho*(0.2500*d_blades**2 - 0.2500*d_hub**2))**1.5000)
...
class CruisePropeller(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input('thrust_total', val= 1 * np.ones(N), desc='total aircraft thrust required', units='N')
    ...
    def setup_partials(self):
        ...
        self.declare_partials('p_shaft_unit', 'thrust_total')
        self.declare_partials('p_shaft_unit', 'u')
        self.declare_partials('p_shaft_unit', 'd_blades')
        self.declare_partials('p_shaft_unit', 'd_hub')
        self.declare_partials('p_shaft_unit', 'rho')
        self.declare_partials('p_shaft_unit', 'n_motors')
