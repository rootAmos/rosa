...
class GroupCDiManta(om.Group):
    ...
    def setup(self):
        ...
        self.add_subsystem('cl_alpha', GroupCLAlphaManta(ray=self.options['ray'], N=N),promotes=['*'])
...
if __name__ == "__main__":
    ...
    ivc.add_output('CL', val=0.2, desc='manta lift coefficient')
    ivc.add_output('CL0', val=0.02, desc='manta zero lift coefficient')
