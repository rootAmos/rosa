...
def create_efficiency_interpolator(points, kernel='thin_plate_spline', epsilon=0.1):
    """
...
def plot_cross_validation(points, kernel='thin_plate_spline', epsilon=0.1):
    ...
    for train_idx, test_idx in kf.split(points):
        ...
        interp = create_efficiency_interpolator(train_points, kernel, epsilon)
...
if __name__ == "__main__":
    ...
    interp_func = create_efficiency_interpolator(points, kernel='thin_plate_spline')
    
    # Plot efficiency map
    plot_efficiency_map(points, interp_func, rpm_max, tq_max)
    
    # Perform cross-validation
    plot_cross_validation(points, 'thin_plate_spline')
